...
public class SlimeMediator : MonoBehaviour
{
    ...
    public IEnumerator PerformAction(SlimeMediator attacker, List<SlimeMediator> turnOrder)
    {
        ...
        //Debug.Log($"{attacker.SlimeName} ataca a {target.SlimeName} con {attacker.equippedWeaponInstance.LootItemConfig.ItemName} contra {target.equippedWeaponInstance.WeaponType}. Bonus de triangulo de armas: {weaponBonus}");
